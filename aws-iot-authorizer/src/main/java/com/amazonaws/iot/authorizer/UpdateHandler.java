...
public class UpdateHandler extends BaseHandlerStd {
    ...
    protected ProgressEvent<ResourceModel, CallbackContext> handleRequest(
        ...
        if (StringUtils.isEmpty(newModel.getAuthorizerName())) {
        ...
        newModel.setAuthorizerName(prevModel.getAuthorizerName());
    ...
    private void validatePropertiesAreUpdatable(final ResourceModel newModel, final ResourceModel prevModel) {
        ...
        } else if (!newModel.getSigningDisabled().equals(prevModel.getSigningDisabled())) {
