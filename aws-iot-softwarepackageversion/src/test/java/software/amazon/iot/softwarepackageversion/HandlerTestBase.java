...
public class HandlerTestBase {
    ...
    protected final static String PKG_VER_ARN = "arn:aws:iot:us-east-1:1234567890:packageversion/packageversionId";
    protected final static String PKG_NAME = "PackageName";
    protected final static String VER_NAME = "VersionName";
    protected final static String PKG_VER_DESC = "description";
