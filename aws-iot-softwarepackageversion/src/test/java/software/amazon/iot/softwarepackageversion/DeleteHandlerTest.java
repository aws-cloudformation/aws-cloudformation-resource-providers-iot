...
public class DeleteHandlerTest extends HandlerTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        final ResourceModel model = ResourceModel.builder().packageName(PKG_NAME).versionName(VER_NAME).build();
    ...
    public void handleRequest_ResourceNotFound() {
        ...
        when(iotClient.deletePackageVersion(any(DeletePackageVersionRequest.class)))
                .thenThrow(ResourceNotFoundException.builder().build());

        assertThrows(CfnNotFoundException.class, () ->
                handler.handleRequest(proxy, request, new CallbackContext(),proxyClient,LOGGER));
        verify(iotClient).deletePackageVersion(any(DeletePackageVersionRequest.class));
    }
