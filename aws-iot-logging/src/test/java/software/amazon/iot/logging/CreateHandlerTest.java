...
public class CreateHandlerTest extends HandlerTestBase {
    ...
    public void handleRequest_SimpleSuccess_WithAllLogsDisabled() {
        ...
        assertThat(iotRequestCaptor.getAllValues().get(1)).isEqualTo(SET_REQUEST);
    ...
    @Test
    public void handleRequest_SimpleSuccess_WithLoggingNotConfigured() {
        ...
        doThrow(NotConfiguredException.builder().build())
                .when(proxy)
                .injectCredentialsAndInvokeV2(eq(GET_REQUEST), any());
