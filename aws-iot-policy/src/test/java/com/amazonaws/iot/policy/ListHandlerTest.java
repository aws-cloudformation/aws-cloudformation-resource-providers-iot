...
public class ListHandlerTest extends PolicyTestBase {
    ...
    @Captor
    ArgumentCaptor<ListPoliciesRequest> policiesRequestCaptor;
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        when(proxy.injectCredentialsAndInvokeV2(any(), any())).thenReturn(ListPoliciesResponse.builder()
                .nextMarker(null)
    ...
    public void handleRequest_PassedNextToken() {
        ...
        verify(proxy).injectCredentialsAndInvokeV2(policiesRequestCaptor.capture(), any());
        assertThat(policiesRequestCaptor.getValue().marker()).isEqualTo(nextToken);
    }
