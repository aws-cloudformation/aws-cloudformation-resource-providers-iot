...
public class ListHandlerTest extends ProvisioningTemplateTestBase {
    ...
    @Captor
    ArgumentCaptor<ListProvisioningTemplatesRequest> templateRequestCaptor;
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        when(proxy.injectCredentialsAndInvokeV2(any(), any())).thenReturn(ListProvisioningTemplatesResponse.builder()
                .nextToken(null)
                .templates(ProvisioningTemplateSummary.builder()
        ...
        assertThat(model.getTemplateName()).isEqualTo(TEMPLATE_NAME);
        assertThat(model.getDescription()).isEqualTo(TEMPLATE_DESCRIPTION);
    ...
    public void handleRequest_PassedNextToken() {
        ...
        verify(proxy).injectCredentialsAndInvokeV2(templateRequestCaptor.capture(), any());
        assertThat(templateRequestCaptor.getValue().nextToken()).isEqualTo(nextToken);
    }
