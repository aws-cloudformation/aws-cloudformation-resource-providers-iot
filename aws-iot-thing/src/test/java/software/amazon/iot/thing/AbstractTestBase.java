...
public class AbstractTestBase {
    ...
    protected final static String T_ID = "thingId";
    protected final static String T_ARN = "arn:aws:iot:us-east-1:1234567890:thing/thingId";
    protected final static String T_Name = "ThingName";
    protected final static String REQUEST_TOKEN = "REQUEST_TOKEN";
    protected final static String LOGICAL_ID = "Thing";
