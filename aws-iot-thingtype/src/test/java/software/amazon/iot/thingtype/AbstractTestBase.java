...
public class AbstractTestBase {
    ...
    protected final static String TT_ID = "thingTypeId";
    protected final static String TT_Name = "thingTypeName";
    protected final static String TT_ARN = "arn:aws:iot:us-east-1:1234567890:thingType/thingTypeId";
    protected final String THING_TYPE_DESCRIPTION = "Thing Type Description";
