...
public class AbstractTestBase {
    ...
    protected final static String BG_ID = "billingGroupId";
    protected final static String BG_Name = "billingGroupName";
    protected final static String BG_ARN = "arn:aws:iot:us-east-1:1234567890:billinggroup/billinggroupId";
    protected final String BILLING_GROUP_DESCRIPTION = "Billing Group Description";
    protected final static String REQUEST_TOKEN = "REQUEST_TOKEN";
    protected final static String LOGICAL_ID = "MyBillingGroup";
